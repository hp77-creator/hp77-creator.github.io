...
Feel free to check out the source code on my GitHub!
`;async function f(){var n;const i=[],e=Object.assign({"/src/content/blogs/about-mudlet.md":l,"/src/content/blogs/building-understanding-mariaDB.md":c,"/src/content/blogs/git-rebase.md":d,"/src/content/blogs/gsoc24.md":h,"/src/content/blogs/kubecon-cloudnativecon.md":u,"/src/content/blogs/welcome.md":m});for(const t in e)try{const o=e[t];if(!o||o.trim()===""){console.warn(`Empty blog post file found: ${t}`);continue}const r=(n=t.split("/").pop())==null?void 0:n.replace(".md","");if(r){const a=g(o,r);a&&i.push(a)}}catch(o){console.error(`Error processing blog post ${t}:`,o);continue}return i.sort((t,o)=>new Date(o.date).getTime()-new Date(t.date).getTime())}async function y(){return(await f()).filter(e=>e.visible!==!1)}async function _(i){try{const e=Object.assign({"/src/content/blogs/about-mudlet.md":l,"/src/content/blogs/building-understanding-mariaDB.md":c,"/src/content/blogs/git-rebase.md":d,"/src/content/blogs/gsoc24.md":h,"/src/content/blogs/kubecon-cloudnativecon.md":u,"/src/content/blogs/welcome.md":m}),n=`/src/content/blogs/${i}.md`;if(n in e){const t=e[n];return!t||t.trim()===""?(console.warn(`Empty blog post file found: ${n}`),null):g(t,i)}return null}catch(e){return console.error(`Error loading blog post ${i}:`,e),null}}function g(i,e){try{const n=i.split(`---
`);if(n.length<3)return console.warn(`Invalid frontmatter format in post: ${e}`),null;const t=n[1];if(!t)return console.warn(`Missing frontmatter in post: ${e}`),null;const o=w(t),r=o.title,a=o.date;if(!r||!a)return console.warn(`Missing required frontmatter fields in post: ${e}`),null;const s=o.visible,b=s?s.toLowerCase()==="true":!0,p=o.tags;return{slug:e,title:r,date:a,description:o.description||"",content:n.slice(2).join(`---
`),visible:b,tags:p}}catch(n){return console.error(`Error parsing blog post ${e}:`,n),null}}function w(i){const e={};try{i.split(`
`).forEach(n=>{const[t,...o]=n.split(":");if(t&&o.length){const r=t.trim(),a=o.join(":").trim();r&&a&&(r==="tags"?e[r]=a.split(",").map(s=>s.trim()):e[r]=a)}})}catch(n){console.error("Error parsing frontmatter:",n)}return e}export{_ as a,y as g};
