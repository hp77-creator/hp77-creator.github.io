import{S as g,i as w,s as _,a as l,c as v,b as k,m as T,g as $,d as S,t as d,e as u,f as I,h as c,j as E,u as A,k as M,l as x}from"./index.8b7b7f6a.js";import{I as D}from"./Icon.4961cb0c.js";function N(i){let t;const a=i[2].default,n=E(a,i,i[3],null);return{c(){n&&n.c()},l(e){n&&n.l(e)},m(e,s){n&&n.m(e,s),t=!0},p(e,s){n&&n.p&&(!t||s&8)&&A(n,a,e,e[3],t?x(a,e[3],s,null):M(e[3]),null)},i(e){t||(d(n,e),t=!0)},o(e){u(n,e),t=!1},d(e){n&&n.d(e)}}}function j(i){let t,a;const n=[{name:"external-link"},i[1],{iconNode:i[0]}];let e={$$slots:{default:[N]},$$scope:{ctx:i}};for(let s=0;s<n.length;s+=1)e=l(e,n[s]);return t=new D({props:e}),{c(){v(t.$$.fragment)},l(s){k(t.$$.fragment,s)},m(s,o){T(t,s,o),a=!0},p(s,[o]){const r=o&3?$(n,[n[0],o&2&&S(s[1]),o&1&&{iconNode:s[0]}]):{};o&8&&(r.$$scope={dirty:o,ctx:s}),t.$set(r)},i(s){a||(d(t.$$.fragment,s),a=!0)},o(s){u(t.$$.fragment,s),a=!1},d(s){I(t,s)}}}function P(i,t,a){let{$$slots:n={},$$scope:e}=t;const s=[["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}],["polyline",{points:"15 3 21 3 21 9"}],["line",{x1:"10",y1:"14",x2:"21",y2:"3"}]];return i.$$set=o=>{a(1,t=l(l({},t),c(o))),"$$scope"in o&&a(3,e=o.$$scope)},t=c(t),[s,t,n,e]}class C extends g{constructor(t){super(),w(this,t,P,j,_,{})}}const K=C,m=`---
...
Currently working through the chapters on replication and partitioning - fascinating stuff about consistency models and consensus algorithms.
`;async function R(){var a;const i=[],t=Object.assign({"/src/content/library/attention-is-all-you-need.md":m,"/src/content/library/awesome-ebpf.md":h,"/src/content/library/designing-data-intensive-applications.md":f,"/src/content/library/think-distributed-systems.md":p});for(const n in t)try{const e=t[n];if(!e||e.trim()===""){console.warn(`Empty library item file found: ${n}`);continue}const s=(a=n.split("/").pop())==null?void 0:a.replace(".md","");if(s){const o=b(e,s);o&&i.push(o)}}catch(e){console.error(`Error processing library item ${n}:`,e);continue}return i.sort((n,e)=>{if(n.status==="reading"&&e.status!=="reading")return-1;if(e.status==="reading"&&n.status!=="reading")return 1;const s=n.year?parseInt(n.year):0;return(e.year?parseInt(e.year):0)-s})}async function L(){return(await R()).filter(t=>t.visible!==!1)}async function V(i){try{const t=Object.assign({"/src/content/library/attention-is-all-you-need.md":m,"/src/content/library/awesome-ebpf.md":h,"/src/content/library/designing-data-intensive-applications.md":f,"/src/content/library/think-distributed-systems.md":p}),a=`/src/content/library/${i}.md`;if(a in t){const n=t[a];return!n||n.trim()===""?(console.warn(`Empty library item file found: ${a}`),null):b(n,i)}return null}catch(t){return console.error(`Error loading library item ${i}:`,t),null}}function b(i,t){try{const a=i.split(`---
`);if(a.length<3)return console.warn(`Invalid frontmatter format in library item: ${t}`),null;const n=a[1];if(!n)return console.warn(`Missing frontmatter in library item: ${t}`),null;const e=B(n),s=e.title,o=e.type;if(!s||!o)return console.warn(`Missing required frontmatter fields in library item: ${t}`),null;const r=e.visible,y=r?r.toLowerCase()==="true":!0;return{slug:t,title:s,type:o,status:e.status,authors:e.authors,year:e.year,url:e.url,description:e.description||"",content:a.slice(2).join(`---
`),visible:y,tags:e.tags}}catch(a){return console.error(`Error parsing library item ${t}:`,a),null}}function B(i){const t={};try{i.split(`
`).forEach(a=>{const[n,...e]=a.split(":");if(n&&e.length){const s=n.trim(),o=e.join(":").trim();s&&o&&(s==="tags"?t[s]=o.split(",").map(r=>r.trim()):t[s]=o)}})}catch(a){console.error("Error parsing frontmatter:",a)}return t}export{K as E,V as a,L as g};
