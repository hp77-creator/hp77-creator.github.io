...
those work in \`guava\` libraries. [Collections which allow null](https://stackoverflow.com/a/62820956/7116645), [Guava author's answer](https://stackoverflow.com/a/67956082/7116645)`,f=`---
...
Feel free to check out the source code on my GitHub!
`;async function M(){var n;const a=[],e=Object.assign({"/src/content/blogs/about-mudlet.md":l,"/src/content/blogs/adding-frm-parser-part-1.md":h,"/src/content/blogs/building-understanding-mariaDB.md":d,"/src/content/blogs/git-rebase.md":c,"/src/content/blogs/git-worktree-debug.md":u,"/src/content/blogs/gsoc24.md":m,"/src/content/blogs/gsoc25.md":g,"/src/content/blogs/index-java-learning.md":p,"/src/content/blogs/india-foss-2025.md":f,"/src/content/blogs/installing-clickhouse-fixing-a-macos-issue.md":w,"/src/content/blogs/intellij-shortcuts.md":b,"/src/content/blogs/kubecon-cloudnativecon.md":y,"/src/content/blogs/notes-competitive-programming.md":k,"/src/content/blogs/open-source-summit-mumbai-2026.md":I,"/src/content/blogs/outing-near-a-lakehouse.md":v,"/src/content/blogs/support-jetstream-proton.md":_,"/src/content/blogs/switch-button-nothing-phone.md":S,"/src/content/blogs/welcome.md":D});for(const t in e)try{const o=e[t];if(!o||o.trim()===""){console.warn(`Empty blog post file found: ${t}`);continue}const i=(n=t.split("/").pop())==null?void 0:n.replace(".md","");if(i){const s=T(o,i);s&&a.push(s)}}catch(o){console.error(`Error processing blog post ${t}:`,o);continue}return a.sort((t,o)=>new Date(o.date).getTime()-new Date(t.date).getTime())}async function x(){return(await M()).filter(e=>e.visible!==!1)}async function L(a){try{const e=Object.assign({"/src/content/blogs/about-mudlet.md":l,"/src/content/blogs/adding-frm-parser-part-1.md":h,"/src/content/blogs/building-understanding-mariaDB.md":d,"/src/content/blogs/git-rebase.md":c,"/src/content/blogs/git-worktree-debug.md":u,"/src/content/blogs/gsoc24.md":m,"/src/content/blogs/gsoc25.md":g,"/src/content/blogs/index-java-learning.md":p,"/src/content/blogs/india-foss-2025.md":f,"/src/content/blogs/installing-clickhouse-fixing-a-macos-issue.md":w,"/src/content/blogs/intellij-shortcuts.md":b,"/src/content/blogs/kubecon-cloudnativecon.md":y,"/src/content/blogs/notes-competitive-programming.md":k,"/src/content/blogs/open-source-summit-mumbai-2026.md":I,"/src/content/blogs/outing-near-a-lakehouse.md":v,"/src/content/blogs/support-jetstream-proton.md":_,"/src/content/blogs/switch-button-nothing-phone.md":S,"/src/content/blogs/welcome.md":D}),n=`/src/content/blogs/${a}.md`;if(n in e){const t=e[n];return!t||t.trim()===""?(console.warn(`Empty blog post file found: ${n}`),null):T(t,a)}return null}catch(e){return console.error(`Error loading blog post ${a}:`,e),null}}function T(a,e){try{const n=a.split(`---
`);if(n.length<3)return console.warn(`Invalid frontmatter format in post: ${e}`),null;const t=n[1];if(!t)return console.warn(`Missing frontmatter in post: ${e}`),null;const o=E(t),i=o.title,s=o.date;if(!i||!s)return console.warn(`Missing required frontmatter fields in post: ${e}`),null;const r=o.visible,C=r?r.toLowerCase()==="true":!0,A=o.tags;return{slug:e,title:i,date:s,description:o.description||"",content:n.slice(2).join(`---
`),visible:C,tags:A}}catch(n){return console.error(`Error parsing blog post ${e}:`,n),null}}function E(a){const e={};try{a.split(`
`).forEach(n=>{const[t,...o]=n.split(":");if(t&&o.length){const i=t.trim(),s=o.join(":").trim();i&&s&&(i==="tags"?e[i]=s.split(",").map(r=>r.trim()):e[i]=s)}})}catch(n){console.error("Error parsing frontmatter:",n)}return e}export{L as a,x as g};
